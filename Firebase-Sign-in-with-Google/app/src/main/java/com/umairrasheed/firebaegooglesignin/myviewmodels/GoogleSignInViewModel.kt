...
class GoogleSignInViewModel : ViewModel() {
    ...
    private suspend fun googleSignIn(context: Context): Flow<Result<AuthResult>> {
        ...
        Log.d("Issue", "in the process of google sign in")
        ...
        return callbackFlow {
            try {
                ...
                val googleIdOption: GetGoogleIdOption = GetGoogleIdOption.Builder()
                    ...
                    .build()
                Log.d("Issue", "Building the google id option")
                ...
                if (credential is CustomCredential && credential.type == GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL) {
                    ...
                    Log.d("Issue", googleIdTokenCredential.toString())
